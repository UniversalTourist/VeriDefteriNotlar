...
İlk önce *base* R işlemleriyle yeni bir değişken oluşturalım ve ismi `transmission` olsun. Bunu da `am` değişkenindeki 1 ve 0'lara göre yapalım: 0 olursa "automatic", 1 olursa "manual" olsun. Burada `$` işareti sizin veri setinizden bir değişken seçmenize yarar (subset yani alt kümeleme gibi düşünebilirsiniz):
...
Bunu bir de tidyverse ile yapalım: `mutate` ve `case_when` 
